        ...
        @csrf                               
                                ...
                                <div class="col-md-12">
                                    <label for="title" class="form-label">Tytuł zgłoszenia</label>
                                        <input type="text" name="title" class="form-control" id="title" value="{{$email->subject}}">
                                </div>
...
{{-- zmiana ajas na focus.. trzeba klinac w fimre zeby zmienily sie adresy lubalbo poszostale pola --}}
<script type="text/javascript">
$(document).ready(function(){
...
{{-- <h1>order form email create</h1>
<h5>{{$email->from_address}}</h5>
<h5>{{$email->from_name}}</h5>
<h5>{{$email->subject}}</h5>
<h5>{{$email->text_plain}}</h5> --}}