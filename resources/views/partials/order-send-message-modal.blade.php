                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="compose-box">
                                        <div class="compose-content">
                                            <form id="message-to-client-form" class="row g-3 needs-validation" action="{{route('message.to.client', $singleOrder->id)}}" method="POST" novalidate enctype="multipart/form-data">
                                            @csrf    
                                                ...
                                                <div class="mb-4 mail-subject">
                                                    ...
                                                    <div class="w-100">
                                                        <input type="text" id="m-subject" name="subject" class="form-control" value="ZgłoszenieNr: #{{$singleOrder->id}}# {{$singleOrder->title}}" required>
                                                        <span class="validation-text"></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="message-content">
                                                    ...
                                                    <textarea  class="" name="content" id="message-content" cols="58" rows="10" required >Wiadomość odnosi sie do zgłoszenia: {{$singleOrder->title}}</textarea>
